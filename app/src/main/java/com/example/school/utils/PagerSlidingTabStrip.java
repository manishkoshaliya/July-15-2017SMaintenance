...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = Color.parseColor("#01AEEA");
	private int underlineColor = Color.parseColor("#01AEEA");
	private int selectedTextColor = Color.parseColor("#01AEEA");
	private int unselectedTextColor = Color.parseColor("#716B6B");
	...
	private int tabTextColor =  R.color.light_gray;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		dividerPadding = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_underlineHeight, dividerPadding);
		...
		textAllCaps = a.getBoolean(R.styleable.PagerSlidingTabStrip_underlineHeight, textAllCaps);
		...
		defaultTabLayoutParams = new LinearLayout.LayoutParams((width/2), LayoutParams.MATCH_PARENT);
